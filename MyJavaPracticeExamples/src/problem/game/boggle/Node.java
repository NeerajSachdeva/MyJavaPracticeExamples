...
class Node {
	...
	/**
	 * Returns whether key is a valid prefix for certain key in this trie. For example: if key "hello" is in this trie, tests with all
	 * prefixes "hel", "hell", "hello" return true
	 * 
	 * @param prefix
	 *            the prefix to check
	...
	public boolean containPrefix(String prefix) {
		...
		if (prefix.length() == 0) {
			...
			return children[childNodePosition] != null
					&& children[childNodePosition].containPrefix(prefix.substring(1));
		}
	}

	/**
	 * Returns whether key is a valid key in this trie. For example: if key "hello" is in this trie, tests with all prefixes "hel", "hell"
	 * return false
	 * 
	 * @param key
	 *            the key to check
